        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 sm:px-8 sm:py-12 sm:gap-x-8 md:py-16">
            ...
            <div class="col-start-1 row-start-2 px-4 sm:pb-16">
                ...
                <p class="flex items-center text-black text-sm font-medium">
                    <img src="img/img.jpg" alt="" class="w-6 h-6 rounded-full mr-2 bg-gray-100">
                ...
                <div class="w-full grid grid-cols-3 grid-rows-2 gap-2">
                    ...
                    <img src="img/img.jpg" alt="" class="absolute inset-0 w-full h-full object-cover bg-gray-100 sm:rounded-lg" />
                    </div>
                    <div class="relative hidden md:block">
                    <img src="img/img.jpg" alt="" class="absolute inset-0 w-full h-full object-cover rounded-lg bg-gray-100" />
                    </div>
                    <div class="relative hidden md:block">
                    <img src="img/img.jpg" alt="" class="absolute inset-0 w-full h-full object-cover rounded-lg bg-gray-100" />
                    </div>
